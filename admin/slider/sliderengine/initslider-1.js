jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        textbgcss:"display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background-color:#fff; opacity:0.6; filter:alpha(opacity=60);",
        ...
        titlecss:"display:block; position:relative; font: 40px Inder,Arial,Tahoma,Helvetica,sans-serif; color:green;font-weight:bold;",
        ribbonimagey:0,
        ribbonimagex:0,
