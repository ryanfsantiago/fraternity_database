...
<?php
 ...
 <select name="org" id="org" onchange="showMadlangPeople(sy.value,category.value,org.value)">
  <option value="" >------</option>
  </select><br />
 </td></tr>
  <tr></tr>
...
<script>
function showMadlangPeople(str,str2,str3)
{
if (str==""&&str2==""&&str3=="")
  {
...
xmlhttp.open("GET","findpeople.php?q="+str+"&r="+str2+"&s="+str3,true);
xmlhttp.send();
}
</script>
</body>
