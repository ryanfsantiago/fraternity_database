...
<div id="content">
  <h1 style="text-align:center;"> Manage Member Information</h1>
  <form>
...
<?php
 ...
 <select name="org" id="org" onchange="showMember(sy.value,category.value,org.value)" onload="showMember(sy.value,category.value,org.value)">
  <option value="" >------</option>
  </select><br />
 </td></tr>
 <tr><td><a href="addmember.php"><input type="button" value=" Add Member"></a></td></tr>
...
<script>
function showMember(str,str2,str3)
{
if (str==""&&str2==""&&str3=="")
  {
